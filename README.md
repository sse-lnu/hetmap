...
- **Edges**: `parent_of` (folder hierarchy), `contains` (folder → file), `belongs_to` (member → file), and typed static dependencies (`Call`, `Import`, `Use`, ...) between file–file and member–member nodes.
<img src="hetmap_schema.svg" alt="Heterogeneous software Graph Scehma and Meta-relations" width="500" />
